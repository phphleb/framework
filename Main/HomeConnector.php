...
class HomeConnector implements Connector
{
    ...
    public function add()
    {
        ...
        return [
            ...
            'Hleb\Constructor\TCreator'=> $vendor.'/phphleb/framework/Constructor/VCreator.php',
            'Hleb\Constructor\VCreator'=> $vendor.'/phphleb/framework/Constructor/TCreator.php',
